...
class QtHsvRectPicker : public QFrame
{
    Q_OBJECT
...
public:
    explicit QtHsvRectPicker(QWidget *parent = nullptr);
    ~QtHsvRectPicker();
...
public Q_SLOTS:
    ...
    void setColor(const QColor &c, bool changeBrightness = false);
