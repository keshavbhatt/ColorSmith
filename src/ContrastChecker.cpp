...
ContrastChecker::ContrastChecker(QWidget *parent, const QColor &initialColor)
  ...
  // Create screen pickers
  m_textScreenPicker = new ScreenPicker(this);
  m_bgScreenPicker = new ScreenPicker(this);

  // Connect screen picker signals
  connect(m_textScreenPicker, &ScreenPicker::colorPicked, this, &ContrastChecker::onTextColorPicked);
  connect(m_textScreenPicker, &ScreenPicker::errorOccurred, this, &ContrastChecker::onPickerError);
  connect(m_bgScreenPicker, &ScreenPicker::colorPicked, this, &ContrastChecker::onBackgroundColorPicked);
  connect(m_bgScreenPicker, &ScreenPicker::errorOccurred, this, &ContrastChecker::onPickerError);
  ...
  // set last used background color from settings
  const QSettings settings;
  if (const auto lastBgColor = settings.value("ContrastChecker/BackgroundColor", QColor(Qt::black)).value<QColor>(); lastBgColor.isValid())
    setBackgroundColor(lastBgColor);
  else
...
void ContrastChecker::setupUI() {
  ...
  m_textHueSlider = new HSLGradientSlider(Qt::Horizontal, HSLGradientSlider::Hue, this);
  m_textHueSlider->setRange(0, 359);
  m_textHueSpin = new QSpinBox(this);
  m_textHueSpin->setRange(0, 359);
  connect(m_textHueSlider, &HSLGradientSlider::valueChanged, m_textHueSpin, &QSpinBox::setValue);
  connect(m_textHueSpin, QOverload<int>::of(&QSpinBox::valueChanged), m_textHueSlider, &HSLGradientSlider::setValue);
  connect(m_textHueSlider, &HSLGradientSlider::valueChanged, this, &ContrastChecker::onTextHslChanged);

  m_textSatSlider = new HSLGradientSlider(Qt::Horizontal, HSLGradientSlider::Saturation, this);
  m_textSatSlider->setRange(0, 100);
  m_textSatSpin = new QSpinBox(this);
  m_textSatSpin->setRange(0, 100);
  m_textSatSpin->setSuffix("%");
  connect(m_textSatSlider, &HSLGradientSlider::valueChanged, m_textSatSpin, &QSpinBox::setValue);
  connect(m_textSatSpin, QOverload<int>::of(&QSpinBox::valueChanged), m_textSatSlider, &HSLGradientSlider::setValue);
  connect(m_textSatSlider, &HSLGradientSlider::valueChanged, this, &ContrastChecker::onTextHslChanged);

  m_textLightSlider = new HSLGradientSlider(Qt::Horizontal, HSLGradientSlider::Lightness, this);
  m_textLightSlider->setRange(0, 100);
  m_textLightSpin = new QSpinBox(this);
  m_textLightSpin->setRange(0, 100);
  m_textLightSpin->setSuffix("%");
  connect(m_textLightSlider, &HSLGradientSlider::valueChanged, m_textLightSpin, &QSpinBox::setValue);
  connect(m_textLightSpin,
          QOverload<int>::of(&QSpinBox::valueChanged),
          m_textLightSlider,
          &HSLGradientSlider::setValue);
  connect(m_textLightSlider, &HSLGradientSlider::valueChanged, this, &ContrastChecker::onTextHslChanged);
  ...
  m_bgHueSlider = new HSLGradientSlider(Qt::Horizontal, HSLGradientSlider::Hue, this);
  m_bgHueSlider->setRange(0, 359);
  m_bgHueSpin = new QSpinBox(this);
  m_bgHueSpin->setRange(0, 359);
  connect(m_bgHueSlider, &HSLGradientSlider::valueChanged, m_bgHueSpin, &QSpinBox::setValue);
  connect(m_bgHueSpin, QOverload<int>::of(&QSpinBox::valueChanged), m_bgHueSlider, &HSLGradientSlider::setValue);
  connect(m_bgHueSlider, &HSLGradientSlider::valueChanged, this, &ContrastChecker::onBackgroundHslChanged);

  m_bgSatSlider = new HSLGradientSlider(Qt::Horizontal, HSLGradientSlider::Saturation, this);
  m_bgSatSlider->setRange(0, 100);
  m_bgSatSpin = new QSpinBox(this);
  m_bgSatSpin->setRange(0, 100);
  m_bgSatSpin->setSuffix("%");
  connect(m_bgSatSlider, &HSLGradientSlider::valueChanged, m_bgSatSpin, &QSpinBox::setValue);
  connect(m_bgSatSpin, QOverload<int>::of(&QSpinBox::valueChanged), m_bgSatSlider, &HSLGradientSlider::setValue);
  connect(m_bgSatSlider, &HSLGradientSlider::valueChanged, this, &ContrastChecker::onBackgroundHslChanged);

  m_bgLightSlider = new HSLGradientSlider(Qt::Horizontal, HSLGradientSlider::Lightness, this);
  m_bgLightSlider->setRange(0, 100);
  m_bgLightSpin = new QSpinBox(this);
  m_bgLightSpin->setRange(0, 100);
  m_bgLightSpin->setSuffix("%");
  connect(m_bgLightSlider, &HSLGradientSlider::valueChanged, m_bgLightSpin, &QSpinBox::setValue);
  connect(m_bgLightSpin, QOverload<int>::of(&QSpinBox::valueChanged), m_bgLightSlider, &HSLGradientSlider::setValue);
  connect(m_bgLightSlider, &HSLGradientSlider::valueChanged, this, &ContrastChecker::onBackgroundHslChanged);
...
void ContrastChecker::onTextHslChanged() {
  ...
  // Update gradient slider base colors
  m_textSatSlider->setBaseColor(m_textColor);
  m_textLightSlider->setBaseColor(m_textColor);
...
void ContrastChecker::onBackgroundHslChanged() {
  ...
  // Update gradient slider base colors
  m_bgSatSlider->setBaseColor(m_backgroundColor);
  m_bgLightSlider->setBaseColor(m_backgroundColor);
...
void ContrastChecker::onPickTextColor() {
  m_textScreenPicker->pickColor();
}

void ContrastChecker::onPickBackgroundColor() {
  m_bgScreenPicker->pickColor();
}

void ContrastChecker::onTextColorPicked(const QColor &color) {
  if (color.isValid()) {
    setTextColor(color);
  }
}

void ContrastChecker::onBackgroundColorPicked(const QColor &color) {
  if (color.isValid()) {
    setBackgroundColor(color);
  }
}

void ContrastChecker::onPickerError(const QString &message) {
...
void ContrastChecker::closeEvent(QCloseEvent *event) {
  ...
  // save baclground color
  QSettings settings;
  settings.setValue("ContrastChecker/BackgroundColor", m_backgroundColor);
